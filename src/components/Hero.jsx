...
export default function Hero (){
    return(
        <>
        <div className=" mt-20 pt-10 w-screen h-fit grid lg:grid-cols-[6fr_7fr] lg:h-fit">
            <div className=" text-left p-10 md:p-20 lg:p-2 lg:pt-8 lg:pl-10 w-full grid justify-self-center h-fit items-center lg:col-start-1 lg:col-end-2">
                <span className=" flex gap-2 text-[#A78BFA] font-semibold text-base p-1 rounded-2xl bg-gray-400/30 pl-3 pr-3 w-fit items-center "> <img src="/star.svg" className=" h-5" alt="" /> AI-Powered Productivety</span>
                ...
                <span className =" text-[#6B7280] text-base md:text-lg font-normal ">Clario helps you streamline tasks, summerise meetings and stay focused on what matters the most</span>
                <br />
                <div className=" w-full mt-5 flex gap-4 md:gap-[10%] justify-start justify-self-center items-center">
                    ...
                    <div className=" mt-2 block cursor-pointer text-[#111827] justify-center items-center p-4 w-fit transition-transform duration-300 ease-in hover:text-black">
                        <span>TUtorial</span>
                    </div>
                </div>
            ...
            <img src="/mo.png" className=" w-[90%] hidden rounded-3xl shadow-md shadow-black lg:block justify-self-center lg:col-start-2 lg:col-end-3" alt="" />
            <div className=" rounded-lg shadow-md shadow-black grid w-[85%] justify-self-center lg:hidden">
                <img src="/mob.png" className=" w-[45%] rounded-lg block justify-self-center lg:hidden" alt="" />
            </div>
            <div className=" grid lg:col-start-1 lg:col-end-3 justify-center w-full text-[#6B7280] mt-10 ">
                ...
                <div className=" mb-4 h-auto flex-wrap justify-center mt-5 flex text-base lg:text-lg font-medium gap-6 w-full md:gap-10 lg:gap-12 p-4">
                    {/* 1st obj */}
